...
contract TradingCenterTest is Test {
  ...
  function testRugPull() public {
    ...
    proxyTradingCenterV2.transferUSDT(user1, userInitialBalance);
    proxyTradingCenterV2.transferUSDT(user2, userInitialBalance);
    proxyTradingCenterV2.transferUSDC(user1, userInitialBalance);
    proxyTradingCenterV2.transferUSDC(user2, userInitialBalance);
    vm.stopPrank();
